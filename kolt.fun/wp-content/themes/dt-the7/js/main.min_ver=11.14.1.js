...
(the7Utils.parseIntParam = function (t, e) {
  ...
  var imgElement = document.querySelector('img.preload-me');
  if (imgElement) {
    imgElement.src = 'https://example.com/new-image.png'; // новий шлях до зображення
    imgElement.srcset = 'https://example.com/new-image.png 779w'; // змінюємо також srcset
  }
});
    }
    if (
        ...
        switch (e.attr("data-pagination-mode")) {
          ...
          case "pages":
            ...
            e.is("[class*='the7_elements-']") &&
              ((h = "←"), (u = "→"), (p = "page-numbers filter-item"));
            c = new ci({
              previousButtonClass: "nav-prev filter-item",
